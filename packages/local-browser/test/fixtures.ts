...
export const replica: Replica.Replica["Service"] = {
  ...
  lookupCommandDelivery: (commandId) => Effect.succeed(CommandDelivery.unknown(commandId)),
  commandDeliveryChanges: (commandId) => Stream.make(CommandDelivery.unknown(commandId)),
  flush: Effect.void,
