...
export const ProjectionRebuild = Workflow.make("EffectLocal/ProjectionRebuild", {
  payload: { ...operation, projection: Schema.String.check(Schema.isMinLength(1)) },
  success: Schema.Void,
  error: ReplicaError.ReplicaError,
  idempotencyKey: (payload) => `${payload.replicaIncarnation}:${payload.operationId}:projection:${payload.projection}`
})
...
export const CreateBackup = Workflow.make("EffectLocal/CreateBackup", {
  payload: operation,
  success: Schema.Void,
  error: ReplicaError.ReplicaError,
  idempotencyKey: (payload) => `${payload.replicaIncarnation}:${payload.operationId}`
...
export const RestoreBackup = Workflow.make("EffectLocal/RestoreBackup", {
  payload: operation,
  success: Schema.Void,
  error: ReplicaError.ReplicaError,
  idempotencyKey: (payload) => `${payload.replicaIncarnation}:${payload.operationId}`
...
export class WorkflowRuntime extends Context.Service<WorkflowRuntime, {
...
}>()("@lucas-barake/effect-local-sql/ReplicaWorkflow/WorkflowRuntime") {}
